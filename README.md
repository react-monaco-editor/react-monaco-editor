...
- `onChange(newValue, event)` an event emitted when the content of the current model has changed. Note that this event is emitted for programmatic and manual changes to the content.
